...
> 说明：这是统一沟通版；服务、数据、支付退款、协议和实时推送的可执行细节以《[架构基线与服务边界](充电运营平台架构基线与服务边界-v2.md)》及《[Kafka 事件目录](../../contracts/events/README.md)》为准。本文件的总图只表达公司级业务域和边界，不表示所有 Kafka 订阅、Schema 或存储连线。
