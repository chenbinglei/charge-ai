...
const activeTheme = ref<ThemeName>("command-deep");
...
.foundation-card__actions button {
  min-height: 40px;
  padding: 0 var(--evco-spacing-2);
  border: 1px solid var(--evco-border);
  border-radius: 6px;
