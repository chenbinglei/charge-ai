 ...
 *
 * <p>叶子菜单携带入口权限码（resource:read）；W3-W11 交付周页面按周追加，
 * 待前端骨架页确定后评估是否迁移入 iam_menu 表。
 */
public final class MenuCatalog {
    ...
    record MenuDef(String key, String title, String path, String permission, List<MenuDef> children) {}
