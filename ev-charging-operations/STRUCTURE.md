...
本文档是当前**物理目录**的唯一说明。服务边界、模块、数据库与部署决策以 [工程架构与数据分库设计 v1.3](docs/design/充电运营平台工程架构与数据分库设计-v1.md) 为准；命名以 [平台技术命名规范 v1](docs/standards/平台技术命名规范-v1.md) 为准。
...
└── delivery/                         # releases、deployment、acceptance 交付资料
```
...
| `backend/services/` | 6 个服务的源代码、测试、服务自身配置。 | 跨服务共享业务实体、其他服务的数据库迁移。 |
...
| `scripts/`、`tests/`、`delivery/` | 自动化、测试资产和可交付证据。 | 临时个人文件、无归属的产物。 |
